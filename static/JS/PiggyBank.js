...
const navLinks = document.querySelectorAll("a").forEach(link =>{
    ...
    function updateSummaryTable(){
        ...
        for(let i=0;i<table.rows.length;i++){
            ...
            if(String(table.rows[i].cells[2].firstChild.nodeValue).includes("Expense") &&((date.getFullYear()==month.substring(6,10)) && (date.getMonth()+1)==month.substring(3,5))){
                countExpenses += 1;
            }
            if(String(table.rows[i].cells[2].firstChild.nodeValue).includes("Expense") && ((date.getFullYear()==month.substring(6,10)) && (date.getMonth()+1)==month.substring(3,5))){
    ...
    function updateKPI(){
        ...
        let table = document.getElementById("AccountingTable");
                ...
                for(let i=0;i<table.rows.length;i++) {
                    month = table.rows[i].cells[3].firstChild.nodeValue;
                    if (String(table.rows[i].cells[2].firstChild.nodeValue).includes("Expense") && (table.rows[i].cells[4].firstChild.nodeValue === "No") && ((date.getFullYear()==month.substring(6,10)) && (date.getMonth() + 1) == month.substring(3,5))) {
...
/*
                    date.getMonth() == 0 && date.getMonth() ==12 && (date.getFullYear()-1)== month.substring(6,10)
*/
                    if (String(table.rows[i].cells[2].firstChild.nodeValue).includes("Expense") && (table.rows[i].cells[4].firstChild.nodeValue === "No") && ((((date.getFullYear() == month.substring(6,10)) && (date.getMonth()) == month.substring(3,5))) || (date.getMonth() == 0 && month.substring(3,5) ==12 && (date.getFullYear()-1)== month.substring(6,10)))) {
                    ...
                    if (String(table.rows[i].cells[2].firstChild.nodeValue).includes("Income") && (date.getFullYear()==month.substring(6,10) && (date.getMonth() + 1) == month.substring(3,5))) {
                        thisMonthInc += Number(table.rows[i].cells[7].firstChild.nodeValue);
                        thisMonthIncNum += 1;

                    }
                    if (String(table.rows[i].cells[2].firstChild.nodeValue).includes("Expense") && ((date.getFullYear()==month.substring(6,10) && (date.getMonth()) == month.substring(3,5)) || (date.getMonth() == 0 && month.substring(3,5) ==12 && (date.getFullYear()-1)== month.substring(6,10)))) {
                        lastMonthExp += Number(table.rows[i].cells[7].firstChild.nodeValue);
                        lastMonthExpNum += 1;

                    }
                    if (String(table.rows[i].cells[2].firstChild.nodeValue).includes("Income") && ((date.getFullYear()==month.substring(6,10) && (date.getMonth()) == month.substring(3,5)) || (date.getMonth() == 0 && month.substring(3,5) ==12 && (date.getFullYear()-1)== month.substring(6,10)))) {
